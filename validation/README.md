...
- Quality bar của nhóm cao hơn mức tối thiểu: thử với 5 người và ít nhất 4/5 người hoàn thành luồng rà soát mà không cần hướng dẫn.
- Sau mỗi vòng phải ghi rõ thay đổi nào được thực hiện từ feedback, hoặc lý do có bằng chứng để chưa đổi.

## Cách thực hiện

1. Mời 5 người không thuộc nhóm, ưu tiên TA/mod hoặc học viên từng dùng Discord học tập.
